...
RPC_IF_HANDLE Calculator_v1_0_c_ifspec = (RPC_IF_HANDLE)& Calculator___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
    ...
    int b)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Calculator_StubDesc,
                  (PFORMAT_STRING) &Calculator__MIDL_ProcFormatString.Format[0],
    ...
    int b)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Calculator_StubDesc,
                  (PFORMAT_STRING) &Calculator__MIDL_ProcFormatString.Format[46],
                  ( unsigned char * )&IDL_handle);
    return ( int  )_RetVal.Simple;
    ...
    int b)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Calculator_StubDesc,
                  (PFORMAT_STRING) &Calculator__MIDL_ProcFormatString.Format[92],
                  ( unsigned char * )&IDL_handle);
    return ( int  )_RetVal.Simple;
    ...
    int b)
{
    ...
    RpcTryFinally
        ...
        ( *(( int * )_StubMsg.Buffer)++ = a ) ;
        
        _StubMsg.Buffer = (unsigned char *)(((long)_StubMsg.Buffer + 3) & ~ 0x3);
        ( *(( int * )_StubMsg.Buffer)++ = b ) ;
